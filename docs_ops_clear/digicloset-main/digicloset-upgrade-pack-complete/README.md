DigiCloset Upgrade Pack - Uploadable code skeleton
...
Use this as a starting point. The services are intentionally lightweight to get a working local dev flow.
